...
func main() {
	...
	offset1 := ig.Text{FontFace: faceName, Text: text1, X: *text1X, Y: *text1Y, MaxWidth: 0.7}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text1, X: *text1X + 0.1, Y: *text1Y}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text1, X: *text1X + 0.2, Y: *text1Y}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text1, X: *text1X, Y: *text1Y + 0.1}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text1, X: *text1X, Y: *text1Y + 0.2}.Draw(&tx)
	...
	ig.Text{FontFace: faceName, Text: text2, X: *text2X + 0.1, Y: *text2Y, RightAlign: true}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text2, X: *text2X + 0.2, Y: *text2Y, RightAlign: true}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text2, X: *text2X, Y: *text2Y + 0.1, RightAlign: true}.Draw(&tx)
	ig.Text{FontFace: faceName, Text: text2, X: *text2X, Y: *text2Y + 0.2, RightAlign: true}.Draw(&tx)
